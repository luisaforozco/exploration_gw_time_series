...
## Requirements
The python environment is cluttered because of the different packages tested and used.
...
- [data_exploration](notebooks/data_exploration/data_exploration.ipynb): how to get data from BRO and DINO via public ways, how does the data look like. How to import and export binary data generated in other notebooks and stored in folder `data`.
